...
export default function EditPatientPage() {
  ...
  //模擬資料（實際之後可以用 useEffect 去 fetch）
  const mockData = {
    name: '王小明',
    age: '70',
    gender: '男',
  ...
  useEffect(() => {
    ...
    setInsuranceNumber(mockData.insuranceNumber)
    setEmergencyContact(mockData.emergencyContact)
    setEmergencyPhone(mockData.emergencyPhone)
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#d6f5f0] px-4">
      <div className="bg-white p-6 rounded-xl shadow-md w-full max-w-xl">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* 送出按鈕 */}
          <div className="pt-2">
            <Button label="確認修改" className="w-full" onClick={() => {}}/>
          </div>
